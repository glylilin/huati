...
//重置回复
$(".replay_reset").live('click',function(){
	$(this).parent().find(".textarea_content").val('');
});
//刪除評論的回复
$(".del_user_second_replay").live('click',function(){
...
//发表
$(".replay_sub").live('click',function(){
	...
	$.ajax({
		...
		success:function(obj){
			...
			//评论点赞
	$('.agree_comment_num').live("click",function(){
	...
	$(".stop_comment_num").live('click',function(){
...
//关注话题
$(".follow_topic").live("click",function(){
...
//异步分页
$(".comment_page span").live("click",function(){
	var qa_id =$(this).attr('data');
...
$(window).scroll(function(){
	...
	$(".teacher_header").delayLoading({
		defaultImg: "/static/images/loading.jpg",           // 预加载前显示的图片
